    ...
    <div className="min-h-[calc(100vh-12rem)] bg-slate-50 py-10">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-[2rem] bg-white p-10 shadow-xl shadow-slate-200">
          <h1 className="text-4xl font-semibold text-slate-900">Saved Addresses</h1>
          <p className="mt-4 text-slate-600">Store multiple delivery and event locations for easy booking.</p>

          {!session ? (
            <div className="mt-10 rounded-[1.75rem] border border-dashed border-slate-300 bg-slate-50 p-10 text-center">
              <p className="text-lg font-medium text-slate-900">Sign in to view your saved addresses.</p>
            ...
            <div className="mt-10 rounded-[1.75rem] border border-slate-200 bg-slate-50 p-10 text-center">
              ...
              <p className="mt-3 text-slate-600">Addresses will be saved automatically after you place an order.</p>
            </div>
          )}
        </div>
      </div>
